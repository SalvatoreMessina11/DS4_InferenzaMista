...
3. Imposta **Context** e **Output massimo**. Il primo contiene prompt, storia e risposta; il secondo limita ciascuna risposta. Il valore iniziale dell'output e 16384, senza il precedente limite fisso di 256. EOS, interruzione o esaurimento del contesto possono concludere prima la risposta.
4. Per due PC imposta IP locali/peer e configura la rete su entrambi. Avvia il worker e poi il coordinatore. Solo il coordinatore riceve prompt. **Anteprima avvio** mostra i parametri senza avviare nulla.
...
Pi e opzionale e va trovato nell'ambiente Ubuntu selezionato. Il launcher cerca anche installazioni utente npm, NVM, pnpm e bun. Un'installazione esclusivamente Windows non diventa automaticamente un comando Linux. La configurazione preserva altri provider e crea backup univoci.
